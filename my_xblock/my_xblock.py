...
class MyXBlock(XBlock):
    ...
    def student_view(self, context=None):
        ...
        html = self.resource_string("html/my_xblock.html")
        frag = Fragment(html.format(self=self))
        frag.add_css(self.resource_string("css/my_xblock.css"))
        ...
        frag.add_javascript(self.resource_string("js/src/my_xblock.js"))
