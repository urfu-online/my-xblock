#!/usr/bin/env python
"""
Package metadata for my_xblock.
"""
import os
import re
import sys
...
VERSION = get_version('my_xblock', '__init__.py')
...
setup(
    ...
    url='https://github.com/urfu-online/my-xblock',
    packages=find_packages(
        include=['my_xblock', 'my_xblock.*'],
        exclude=["*tests"],
    ),
    ...
    entry_points={
        'xblock.v1': [
            'my_xblock = my_xblock:MyXBlock',
        ]
    },
    package_data=package_data("my_xblock", ["static", "public"]),
