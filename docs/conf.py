...
"""
my-xblock documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'my-xblock',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/urfu-online/my-xblock",
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'my_xblock'),
                os.path.join(root_path, 'my_xblock/migrations')])
